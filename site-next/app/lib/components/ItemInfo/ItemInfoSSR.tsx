...
import { BreadcrumbsSSR } from '../Breadcrumbs'
import { ItemInCartType } from '../../types/site.type'


export type ItemInfoSSRProps = CombinedItemType & {
  className?: string
}


const ItemInfoSSR: FC<ItemInfoSSRProps> = ({ className, ...item }) => {
  ...
  return (
    <div className={className}>
      ...
      >
        <BreadcrumbsSSR pathname={`/product/${item.link}/`} />
